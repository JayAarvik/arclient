      ...
      <ImageBackground source={home_bg} style={Style.bgImage} blurRadius={4}>
            <View style={Style.contentView}>
                    ...
                    <View style={Style.firstHeading}>
                        <Txt s={30} pt={10} w="600" c="w">Everyday Solution</Txt>
                        <Txt s={30} pt={10} w="600" c="w" mt={10}>for Grocery</Txt>
                        <Txt s={30} pt={10} w="600" c="w" mt={10}>Shopping</Txt>
                        <Txt s={15} pt={10} w="400" c="w" mt={5}>
                            We are here for helping you organize your
                        </Txt>
                    ...
                    <View style={Style.submitBtnsStyle}>
                            <TouchableOpacity style={Style.submitBtnStyle} onPress={() => startBtn()}>
                                <Txt a="c" c="bgr" s={15} w="500">Start Shopping</Txt>
                            </TouchableOpacity>               
                            <Txt a="c" c="w" mt={10}>
                                Don't have an account?
                            <Txt c="w" w="500" onPress={() => registerNow()}> Register</Txt>
                            </Txt>         
                    </View>
            </View>
      </ImageBackground>
