...
export default function AllItems({ navigation }) {
    ...
    const [todayData, setTodayData] = useState([
        ...
        { id: 5, name: "Chicken Biryani", type: "Spicy", pImage: require('../../images/Items/item3.jpg') },
        { id: 6, name: "Yotam Ottolenghi", type: "Salty", pImage: require('../../images/Items/item1.jpg') },
        { id: 7, name: "Hanoi-style Eggs", type: "Salty", pImage: require('../../images/Items/item2.jpg') },
    ]);
    const goBack = () => {
        navigation.goBack();
    }
